  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast({ title: "Error", description: data.error || "Subscription failed.", variant: "destructive" })
      }
    } catch (err) {
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2" onSubmit={handleSubmit}>
              <Input
                ...
                disabled={loading}
              />
              <Button className="bg-terracotta hover:bg-terracotta/90 text-white" type="submit" disabled={loading}>
